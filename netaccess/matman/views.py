...
class MaterialAddView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    ...
    fields = ['serial_number', 'material_number', 'manufacturer', 'description', 'department', 'owner', 'tags',
              'is_active']
...
class MaterialEditView(LoginRequiredMixin, SuccessMessageMixin, UpdateView):
    ...
    fields = ['serial_number', 'material_number', 'manufacturer', 'description', 'department', 'location', 'owner',
              'tags', 'is_active']
    slug_field = 'identifier'
    slug_url_kwarg = 'identifier'
...
class BorrowAddView(LoginRequiredMixin, SuccessMessageMixin, CreateView):
    model = Borrow
    template_name_suffix = '_create'

    fields = ['item', 'material_number', 'manufacturer', 'description', 'department', 'owner', 'tags',
              'is_active']
...
class MaterialListView(ListView):
    ...
    fields = ['serial_number', 'material_number', 'manufacturer', 'department', 'owner', 'tags', 'is_active']
    paginate_by = 50
